...
public abstract class Button implements ButtonInterface {
	...
	protected boolean rescaleText = true;
	...
	protected void setTextOffset(Graphics g){
		FontMetrics fm = g.getFontMetrics();
		
		if(text != null)
			offsettext = xSize/2-fm.stringWidth(text)/2;
		if(subtext2 != null)
			offsetSubtext2 = xSize/2-fm.stringWidth(subtext2)/2;
